...
<div className="relative top-[8vh] w-[80vw] h-[2500px] lg:w-[1600px] lg:h-[2100px] grid grid-cols-1 md:grid-cols-6 grid-rows-12 md:grid-rows-12 gap-2 md:gap-2 m-4">
      <div className="col-start-1 row-start-1   bg-slate-800 gap-5 md:col-start-1 md:row-start-1 md:col-span-4 md:row-span-1 lg:bg-slate-800 rounded-md p-10">
        <h1 className="relative top-2 lg:relative lg:top-[2vh] text-center text-2xl headingA text-yellow-600 lg: lg:text-6xl">gastlichkeit ist unsere philosophie</h1>
      </div>
      <div className="hidden lg:relative col-start-1 row-start-2   bg-green-500 md:col-start-5 md:row-start-1 md:col-span-2 md:row-span-2 lg:bg-slate-800 rounded-md p-10">
      ...
      <div className="col-start-1 row-start-2 row-span-4   md:col-start-1 md:row-start-2 md:col-span-2 md:row-span-3 bg-red-900 rounded-md p-10">
        <div className=" lg:relative lg:top-[5vh] lgleft-[4vw] lg:w-96">
          <Image src={Astra} alt="Astra vom Fass" width={500} height={200} />
        </div>
      </div>
      <div className="col-start-1 row-start-3 row-span-2   md:col-start-3 md:row-start-2 md:col-span-1 md:row-span-3 bg-slate-800 rounded-md p-10">
<h1 className="lg:relative lg:top-[4vh] text-xl text-center headingA text-yellow-600 lg:text-4xl">Bier vom Fass</h1>
      ...
      <div className="col-start-1 row-start-4 row-span-4  md:col-start-4 md:row-start-3 md:col-span-2 md:row-span-3 bg-yellow-800 rounded-md p-10">
          <div className="lg:relative lg:top-[5vh] flex flex-col items-center ">
            <Image src={Wine} alt="Wine Illustration" width={500} height={300} />
          </div>

      </div>
      <div className="col-start-1 row-start-14 row-span-2   md:col-start-6 md:row-start-3 md:col-span-1 md:row-span-3 bg-yellow-800 rounded-md p-10">
     <h1 className="lg:relative lg:top-[5vh] text-4xl text-center headingA text-yellow-600 lg:text-4xl">regionale Weine</h1>
            <h2 className="lg:relative lg:top-[8vh] text-center text-xl text-white lg:text-2xl">
      ...
      <div className="col-start-1 row-start-16 row-span-2   md:col-start-1 md:row-start-5 md:col-span-1 md:row-span-3 bg-stone-800 rounded-md p-10">
 <h1 className="lg:relative lg:top-[3vh] text-2xl text-center headingA text-yellow-600 lg:text-3xl">Cocktails & Longdrinks</h1>
          <h2 className="lg:relative lg:top-[5vh] text-xl text-center text-white lg:text-[1.4rem]">
      ...
      <div className="col-start-1 row-start-18 row-span-4   md:col-start-2 md:row-start-5 md:col-span-2 md:row-span-3 bg-stone-800 rounded-md p-10">
<div className="w-32 lg:relative lg:top-[2vh] lg:left-[8vw] lg:w-[60vw] lg:h-[60vh] justify-center">
            <Image src={Cocktail} alt="CocktailIcon" width={250} height={250} />
          </div>


      </div>
      <div className="col-start-1 row-start-22 row-span-2   md:col-start-4 md:row-start-6 md:col-span-2 md:row-span-2 bg-red-900 rounded-md p-10">
 
          <h1 className="lg:relative lg:top-[5vh] text-center text-4xl headingA text-yellow-600 lg:text-5xl">fussball tv live</h1>
          <h2 className="text-xl text-center text-white lg:text-[1.1rem] lg:relative lg:top-[5vh]">
      ...
      <div className="col-start-1 row-start-24 row-span-4   md:col-start-6 md:row-start-6 md:col-span-1 md:row-span-3 bg-red-900 rounded-md p-10">
      ...
      <div className="col-start-1 row-start-28 row-span-4   md:col-start-1 md:row-start-8 md:col-span-2 md:row-span-1 bg-slate-800 rounded-md p-10">
      ...
      <div className="col-start-1 row-start-32 row-span-2   md:col-start-3 md:row-start-8 md:col-span-3 md:row-span-1 bg-slate-800 rounded-md p-10">
        
        </div>
      <div className="col-start-1 row-start-34 row-spn-2   md:col-start-1 md:row-start-9 md:col-span-2 md:row-span-3 bg-yellow-800 rounded-md p-10">
      ...
      <div className="col-start-1 row-start-36 row-span-4  md:col-start-3 md:row-start-9 md:col-span-1 md:row-span-3 bg-yellow-800 rounded-md p-10">
       <div className="lg:relative lgtop-[5vh] flex flex-col items-center  justify-center">


            <Image src={Crowdparty} alt="Crowd Illustration" width={600} height={200} />
          </div>
      </div>
      <div className="col-start-1 row-start-40 row-span-4   md:col-start-4 md:row-start-9 md:col-span-2 md:row-span-3 bg-stone-600 rounded-md p-10">
      ...
      <div className="col-start-1 row-start-44 row-span-4   md:col-start-6 md:row-start-9 md:col-span-1 md:row-span-3 bg-stone-600 rounded-md p-10">
        <div className="w-24 flex flex-col items-center lg:relative top-[5vh]">
