...
<div className="relative top-[8vh] w-[86vw] h-[5100px] lg:w-[1600px] lg:h-[2100px] grid grid-cols-1 md:grid-cols-6 grid-rows-12 md:grid-rows-12 gap-2 md:gap-2 m-4">
      <div className="col-start-1 row-start-1 row-span-2  bg-slate-800 gap-5 md:col-start-1 md:row-start-1 md:col-span-4 md:row-span-1 lg:bg-slate-900 rounded-md p-10">
        <h1 className="relative lg:relative lg:top-[2vh] text-center top-10 text-6xl headingA text-slate-600 lg: lg:text-6xl">unser angebot und unser service</h1>
      </div>
      <div className="lg:relative col-start-1 row-start-3 row-span-2   bg-slate md:col-start-5 md:row-start-1 md:col-span-2 md:row-span-2 lg:bg-slate-800 rounded-md p-10">
      ...
      <div className="col-start-1 row-start-5 row-span-3   md:col-start-1 md:row-start-2 md:col-span-2 md:row-span-3 bg-red-900 rounded-md p-10">
        <div className="relative top-12 lg:relative lg:top-[5vh] lg:left-[4vw] ">
...
<h1 className="relative top-7 lg:relative lg:top-[4vh] text-4xl text-center headingA text-yellow-600 lg:text-4xl">bier vom fass</h1>
      ...
      <div className="col-start-1 row-start-10 row-span-2  md:col-start-4 md:row-start-3 md:col-span-2 md:row-span-3 bg-yellow-800 rounded-md p-10">
...
<h1 className="relative top-5 lg:top-[3vh] text-3xl text-center headingA text-yellow-600 lg:text-3xl">Cocktails & Longdrinks</h1>
          <h2 className="relative top-5 lg:top-[5vh] text-xl text-center text-white lg:text-[1.4rem]">
      ...
      <div className="col-start-1 row-start-28 row-span-2   md:col-start-4 md:row-start-6 md:col-span-2 md:row-span-2 bg-red-900 rounded-md p-10">
      ...
      <div className="col-start-1 row-start-30 row-span-4   md:col-start-6 md:row-start-6 md:col-span-1 md:row-span-3 bg-red-900 rounded-md p-10">
      ...
      <div className="col-start-1 row-start-34 row-span-4   md:col-start-1 md:row-start-8 md:col-span-2 md:row-span-1 bg-slate-800 rounded-md p-10">
      ...
      <div className="col-start-1 row-start-38 row-span-2   md:col-start-3 md:row-start-8 md:col-span-3 md:row-span-1 bg-slate-800 rounded-md p-10">
        
        </div>
      <div className="col-start-1 row-start-40 row-spn-2   md:col-start-1 md:row-start-9 md:col-span-2 md:row-span-3 bg-yellow-800 rounded-md p-10">
      ...
      <div className="col-start-1 row-start-42 row-span-4  md:col-start-3 md:row-start-9 md:col-span-1 md:row-span-3 bg-yellow-800 rounded-md p-10">
      ...
      <div className="col-start-1 row-start-46 row-span-4   md:col-start-4 md:row-start-9 md:col-span-2 md:row-span-3 bg-stone-600 rounded-md p-10">
      ...
      <div className="col-start-1 row-start-50 row-span-5   md:col-start-6 md:row-start-9 md:col-span-1 md:row-span-3 bg-stone-600 rounded-md p-10">
        <div className="w-80 flex flex-col items-center lg:relative top-[5vh]">
